...
class CTGovClient:
    ...
    @staticmethod
    def fetch_studies(query_name: str, condition: str, phases: list, sponsor: str, statuses: list, limit: int = 1000):
        ...
        params = {
            ...
            "pageSize": page_size,
            "format": "json",
            # ZAKTUALIZOWANE POLA: Dociągamy szczegóły protokołów dla Gemini (DesignModule, EligibilityModule)
